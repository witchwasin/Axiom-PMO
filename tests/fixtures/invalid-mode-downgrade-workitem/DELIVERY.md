# DELIVERY - INVALID-MODE-DOWNGRADE-WORKITEM
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| D-001 | Strict | authentication | normal feature | Fixture PM | Request submission | REQ-001 | DESIGN/FLOW.puml | Valid request is accepted | Happy | Fixture Dev | high | Review / Test | qa | Fixture test | review:qa |
