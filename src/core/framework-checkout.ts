...
export function testFrameworkCheckout(root: string): boolean {
...
export function frameworkCheckoutFailureMessage(root: string, toolName: string, alternative = "node cli/axiom.mjs validate --project <your project>"): string {
  return [
