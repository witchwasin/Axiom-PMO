...
| DEC-003 | Part photos are classified internal-only and are purged on demo reset. | Sponsor asked that photos not leave the site network; the demo dataset is disposable. | MOM-20260714 item 5 | 2026-07-15 | Dev Team |
