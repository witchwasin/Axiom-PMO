...
|---|---|---|---|
| Rear camera | AC-001 scan flow | open | DEC-005 |
...
| Part photo file | yes |  | DEC-003 purged on demo reset |
...
| AC-002 | REQ-002 | Given on_hand of 12, when 5 are consumed, then on_hand is 7 | automated |  | scripts/reset-demo.sh |
