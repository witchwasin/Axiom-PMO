...
#
# Independent AI Reviewer's independent review found this MAJOR: closure_policy.settable_by was
...
#
# Independent AI Reviewer's independent review of this branch found this FATAL: the original
...
"@
    ...
    # UNRELATED to the pinned one -- Independent AI Reviewer's exact reproduction.
