...
export function testRequiredArtifacts(
  ...
  for (const artifact of allTrackedArtifacts) {
    ...
    if ((artifact === "HANDOFF.md" || artifact === "DESIGN/BUILD-SPEC.md" || artifact === "DESIGN/SRS.md" || artifact === "DESIGN/DATA-FLOW.md" || artifact === "DESIGN/DATA-DICTIONARY.md" || artifact === "DESIGN/ERD.puml" || artifact === "TESTS/TEST-CASES.md") && requirement === "optional") continue;
    if (artifact === "DESIGN") {
