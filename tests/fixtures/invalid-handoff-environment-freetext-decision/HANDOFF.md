...
| Consume and receive stock | D-003 | Shows the count moving in both directions, which is the point | R. Silva |
...
| demo | Sponsor's Android tablet, Chrome 126 | HTTPS from a local reverse proxy with a certificate trusted by the tablet | agreed in the kickoff |
...
- Readiness evidence: [HANDOFF-REVIEW.json](HANDOFF-REVIEW.json)
