# RELEASE - INVALID-STRICT-ALL-TESTS-SKIPPED
...
|---|---|---|---|---|
| TEST-001 | Role-based access | skipped | DEC-003 | Environment unavailable this cycle. |
| TEST-002 | Audit record | skipped | DEC-003 | Environment unavailable this cycle. |
