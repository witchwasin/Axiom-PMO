...
|---|---|---|---|---:|---|
| REQ-001 | Only users with Export Approver role can approve exports. | permission | REQ-20260710 row 1 | supported | confirmed |
| REQ-002 | Export action must write an audit record. | audit | REQ-20260710 row 2 | supported | confirmed |
...
| Design Ready | Demo Security Lead | 2026-07-10 | DEC-002 |
