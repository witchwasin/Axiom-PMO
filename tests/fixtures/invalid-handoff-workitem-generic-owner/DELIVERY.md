...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| D-001 | Standard | none | shared prerequisite | Demo PM | Part master and stock schema | REQ-002, BR-001 | DESIGN/BUILD-SPEC.md | Part and stock entities exist with whole-piece quantities | Schema migration, constraint | Dev Team | high | To Do | none | DEC-002 | |
